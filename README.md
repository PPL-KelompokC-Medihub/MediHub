...
| Ghifari Derriel Aryasatya | Developer | PBI-03: Register + Login (Pasien), **PBI-18**: Catatan Medis & Resep Obat (Dokter), **PBI-19**: Hasil Diagnosa & Catatan Medis (Pasien), **PBI-20**: Riwayat Jadwal Temu (Dokter) |
