...
@section('title', 'Buat Catatan Medis - MediHub')
...
<div style="max-width: 800px; margin: 0 auto; padding: 20px;">
    ...
    <h1 class="header-title">Buat Catatan Medis</h1>
    <p class="header-subtitle">Masukkan detail hasil pemeriksaan dan diagnosa pasien di bawah ini.</p>
    ...
    <form action="{{ route('dokter.medical_notes.store') }}" method="POST">
        ...
        <div class="form-section">
            <h2 class="section-title">Informasi Catatan Medis</h2>
        ...
        <div class="footer-action">
            <div style="display: flex; gap: 16px; align-items: center;">
                <button class="btn-primary" type="submit" style="flex: 2; height: 50px; padding: 0;">Simpan Catatan Medis</button>
