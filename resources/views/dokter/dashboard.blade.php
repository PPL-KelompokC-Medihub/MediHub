...
@section('content')
    ...
    <div>
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
            ...
            <a href="{{ route('dokter.jadwal.index') }}" class="mediq-primary-btn" style="display:flex;align-items:center;gap:8px;padding:8px 16px;font-size:13px;text-decoration:none">
