...
@section('title', 'Sign Up Pasien - MediHub')
...
@section('content')
    <div class="mediq-auth-body">
        ...
        <p class="mediq-auth-subtitle">Daftarkan diri Anda sebagai pasien dan nikmati kemudahan akses layanan kesehatan tanpa antre.</p>

        <p class="mediq-auth-switch">Sudah memiliki akun? <a href="{{ route('login-pasien') }}">Sign in</a></p>

        <form id="firebase-sign-up-form" class="mediq-auth-form" data-sign-in-url="{{ route('login-pasien') }}"
            ...
            <div class="mediq-field-block">
                ...
                <div class="mediq-role-fixed" aria-label="Role akun">Pasien</div>
            </div>
...
@section('page-scripts')
    @vite('resources/js/auth-pasien/pasien-sign-up.js')
@endsection
