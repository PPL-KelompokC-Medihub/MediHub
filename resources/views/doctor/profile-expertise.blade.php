...
<head>
    ...
    @vite(['resources/css/doctor/profile-form.css', 'resources/js/doctor/profile-expertise.js'])
</head>
...
<body class="doctor-ui-pending">
    ...
    <main class="main-content">
        ...
        <form id="doctorExpertiseForm" method="POST" action="{{ route('doctor.profile.expertise.update') }}">
            @csrf
