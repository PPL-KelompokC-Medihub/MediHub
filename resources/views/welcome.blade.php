        ...
        <div class="hero-btns">
            <button class="cta-btn cta-btn-blue">
                ...
                <span class="cta-icon cta-icon-blue">
                    <img src="https://c.animaapp.com/mo3i2i8wgsBU2q/img/vuesax-linear-arrow-right.svg" alt="arrow" />
                </span>
            </button>
    ...
    <section class="service-highlights">
        ...
        <div class="service-grid-v3">
            ...
            <div class="service-card-v3">
                ...
                <p>Kami menyediakan layanan kesehatan bagi ibu hamil dan wanita, mulai dari pemeriksaan rutin, konsultasi
                    kehamilan, hingga perawatan kesehatan reproduksi dengan dukungan dokter yang berpengalaman.</p>
            </div>
            ...
            <div class="service-card-v3">
                ...
                <p>Kami memberikan perawatan gigi dan mulut secara menyeluruh, mulai dari pemeriksaan rutin, pembersihan,
                    penambalan, hingga perawatan lanjutan untuk menjaga senyum sehat Anda.</p>
            </div>
            ...
            <div class="service-card-v3">
                ...
                <p>Kami menyediakan layanan pemeriksaan kesehatan dasar dengan penuh kepedulian untuk membantu Anda menjaga
                    kondisi tubuh, mencegah penyakit, serta mendapatkan penanganan medis awal yang tepat.</p>
            </div>
            ...
            <div class="service-card-v3">
                ...
                <p>Kami memberikan layanan kesehatan khusus anak dengan penuh perhatian dan kasih sayang, mulai dari
                    pemeriksaan rutin, imunisasi, hingga penanganan penyakit agar tumbuh kembang si kecil tetap optimal.</p>
            </div>
        </div>
    </section>
            ...
            <div class="doctor-info">
                ...
                <div class="doctor-meta">
                    <div class="doctor-rating">
                        <img src="https://c.animaapp.com/mo3i2i8wgsBU2q/img/material-symbols-star-rounded.svg" alt="star" />
                        5.0
                    </div>
