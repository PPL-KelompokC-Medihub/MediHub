...
@section('auth_page_class', 'mediq-signin-page mediq-patient-login-page')
@section('auth_visual_image', asset('images/auth-hospital.png'))

@section('content')
    <div class="mediq-auth-body">
        <h1 class="mediq-auth-heading">Selamat Datang Kembali!</h1>
        <p class="mediq-auth-subtitle">Masuk ke akun Anda untuk melanjutkan akses layanan kesehatan dengan mudah.</p>
...
@section('page-scripts')
    @vite('resources/js/auth/pasien/sign-in.js')
@endsection
