...
class LayananTest extends DuskTestCase
{
    ...
    Public function test_buka_layanan(): void
    {
        $this->browse(function (Browser $browser) {
            $this->loginPasien($browser);

            $browser->clickLink('Layanan')
                ->waitforLocation('/pasien/layanan', 10)
                ->assertPathIs('/pasien/layanan')
                ->screenshot('layanan-berhasil');
        });
    }
}
