...
/**
 * Halaman publik & profil dokter yang dapat diakses pasien.
 *
 * Bagian ini berfungsi sebagai katalog dokter (PBI-09 / PBI-10):
 * - services()  : daftar dokter per spesialisasi (poli)
 * - show()      : detail satu dokter beserta jadwal yang tersedia
 */
class DokterPublicController extends Controller
{
    ...
    public function show(string $id): View
    {
        ...
        return view('dokter.show', compact('doctor', 'availableSlots', 'timeSlots'));
    }
    ...
    public function services(): View
    {
        ...
        return view('dokter.services', compact('doctors', 'specialties'));
    }
}
